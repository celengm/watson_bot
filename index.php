            ...
            switch ($event['message']['type']) {
                case 'text':
                    ...
                    if ($receiveText == '1') {
                        ...
                        $actions = array (
                            New \LINE\LINEBot\TemplateActionBuilder\PostbackTemplateActionBuilder("yes", "text 1"),
                            New \LINE\LINEBot\TemplateActionBuilder\PostbackTemplateActionBuilder("no", "text 2")
                        );
