        ...
        if ($event['type'] == 'message') {
            switch ($event['message']['type']) {
                case 'text':
                    ...
                    if ((strpos($receiveText, 'เช็คอิน') !== false) && $receiveText != 'อรขอข้อมูลเช็คอินวันนี้หน่อย' && $receiveText != 'ข้อมูลเช็คอินวันนี้') {
                    ...
                    if ($receiveText == 'บริษัทอยู่ที่ไหน') {
                    ...
                    } else if (strpos($receiveText, 'สอนอร') !== false) {
                        $x_tra = str_replace("สอนอร", "", $receiveText);
                        ...
                        if ($queryFindQustion->rowCount() == 0) {
                            ...
                            $textMessageBuilder = new TextMessageBuilder('ขอบคุณนะจ้ะที่ช่วยสอนอร');
                    ...
                    } else if ($receiveText == 'คำสั่งอร') {
                        $respMessage = " ขอบคุณน้าที่พาเข้ากลุ่ม จ้า \n
                น้องชื่ออรนะคะ น้องถูกสร้างมาขึ้นเพื่อพูดคุย ขำๆ กับ พี่ๆ เลี่ยนอุดม จ้า  \n
...
- ขอวาร์ปหน่อย  \n
- ซื้อเสื้อหน่อย  \n
- สอนอรพูดด้วยนะคะ สอนอร[คำถาม|คำตอบ] เช่น สอนอร[ใครหน้าตาดีที่สุด|คุณวัติจ้า] \n
- อรขอสุ่มชื่อสมาชิกหน่อย \n
- ข้อมูลเช็คอินวันนี้ \n
...
- ขอคะแนนกวนตีน 
                    ...
                    } else if ($receiveText == 'อรขอข้อมูลเช็คอินวันนี้หน่อย' || $receiveText == 'ข้อมูลเช็คอินวันนี้') {
                    ...
                    } else if ($receiveText == 'อรขอสุ่มชื่อสมาชิกหน่อย') {
...
//                        $url = 'http://data.tmd.go.th/api/WeatherWarningNews/v1/?uid=u60pongniwat.w&ukey=4643b5996103347437e6c710bd14f8a9&format=json';
                ...
                case 'location':
                    ...
                    $textMessageBuilder = "อรคำนวณระยะเส้นทางให้นะคะ จากจุดตำแหน่งของคุณถึง ซอฟท์แวร์ปาร์ค \n";
